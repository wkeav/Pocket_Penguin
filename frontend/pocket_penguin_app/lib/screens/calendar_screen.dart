          ...
          ArcticCard(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _buildActionButton('Sync Calendar', Icons.sync, Colors.purple),
                    const SizedBox(width: 8),
                    _buildActionButton('Set Reminder', Icons.notifications, Colors.orange),
                  ],
                ),
              ],
            ),
          ...
          ArcticCard(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _buildProgressItem('Habits Completed', '89', '95%', Colors.green),
                    const SizedBox(width: 16),
                ...
                Row(
                  children: [
                    _buildProgressItem('Journal Entries', '12', '40%', Colors.purple),
                    const SizedBox(width: 16),
                    _buildProgressItem('Fish Coins Earned', '340', '+15%', Colors.amber),
                  ],
                ),
              ],
            ),
